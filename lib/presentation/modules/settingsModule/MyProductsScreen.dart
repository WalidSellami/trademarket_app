...
class MyProductsScreen extends StatelessWidget {
              ...
              body: (checkCubit.hasInternet) ? ConditionalBuilder(
                ...
                builder: (context) => ListView.separated(
                  physics: const BouncingScrollPhysics(),
                      itemBuilder: (context , index) => buildItemMyProduct(myProducts[index] , myIdProducts[index] , numberFavorites , context),
  ...
  Widget buildItemMyProduct(ProductModel model , productId , numberFavorites  , context) => GestureDetector(
    onTap: () {
