...
class FavoritesScreen extends StatelessWidget {
            ...
            return Scaffold(
              body: ConditionalBuilder(
                ...
                builder: (context) => ListView.separated(
                    ...
                    itemBuilder: (context, index) => buildItemMyFavoriteProduct(
                        myFavoriteProducts[index],
                        myIdFavoriteProducts[index],
                        numberFavorites,
                        context),
                ...
                fallback: (context) => (state is LoadingGetAllProductsAppState)
  ...
  Widget buildItemMyFavoriteProduct(
                        ...
                        if (model.uIdVendor != uId)
                          Material(
                            ...
                            child: InkWell(
                              borderRadius: BorderRadius.circular(16.0),
                              onTap: () {
                                if (model.favorites?[uId] == false ||
                                    model.favorites?[uId] == null) {
                                  AppCubit.get(context)
                                      .addProductFavorite(productId: productId);
                                } else {
                                  AppCubit.get(context).removeProductFavorite(
                                      productId: productId);
                                }
                              },
                              child: Padding(
