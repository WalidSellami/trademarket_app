...
class FourthCategoryScreen extends StatelessWidget {
  const FourthCategoryScreen({super.key});
                ...
                builder: (context, state) {
                  ...
                  return BlocConsumer<AppCubit, AppStates>(
                    ...
                    builder: (context, state) {
                      ...
                      var products = cubit.fourthCategory;
                      var idProducts = cubit.idFourthCategory;
