...
class FifthCategoryScreen extends StatelessWidget {
  const FifthCategoryScreen({super.key});
                ...
                builder: (context, state) {
                  ...
                  return BlocConsumer<AppCubit, AppStates>(
                    ...
                    builder: (context, state) {
                      ...
                      var products = cubit.fifthCategory;
                      var idProducts = cubit.idFifthCategory;
